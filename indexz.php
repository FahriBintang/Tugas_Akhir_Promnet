...
<body class="fw-bold fs-4 text-black" style="font-family: 'Poppins';">
    ...
    <section class="p-3">
        <div class="container">
            ...
            <h1 class="fw-bold fs-3">Hello User! Welcome to OurMusic</h1>

            <div class="d-flex justify-content-between align-items-center">
                <a href="playlist.php">
                    <button class="mb-2 btn-sm btn-warning">Playlist</button>
                </a>
                    ...
                    <ul class="pagination">
                        ...
                        <?php for ($i = 1; $i <= $jumlahHalaman; $i++) : ?>
                            <?php if ($i == $halamanAktif) : ?>
                                <li class="mb-2 btn-sm btn-warning" class="page-item active">
                                    <a class="page-link" href="?halaman=<?= $i; ?>"><?= $i; ?></a>
                                </li>
                            <?php else : ?>
                                <li class="mb-2 btn-sm btn-warning" class="page-item">
                                    <a class="page-link" href="?halaman=<?= $i; ?>"><?= $i; ?></a>
                                </li>
                            <?php endif; ?>
                        <?php endfor; ?>
            ...
            <table  class="table table-bordered table-sm fs-6">
                ...
                <tr>
                    ...
                    <td>                       
                        <a href="tambah_playlist.php?id=<?= $data['id'] ?>">
                            <button class="btn-sm btn-warning">Add</button>
                        </a></td>
                </tr>
                <?php $no++; ?>
                <?php endforeach; ?>
